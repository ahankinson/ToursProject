...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'goudimel_phrase', (
            ...
            ('phrase_start', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('phrase_stop', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
